...
if (document.querySelector('.map')) {
  let center = [56.30464518047854, 43.833528];
  function init() {
    let map = new ymaps.Map('map', {
      center: center,
      zoom: 16
    });
    let myPlacemark = new ymaps.Placemark(center, null, {
...
const swipersWorks = document.querySelector('.work-slider');
if (swipersWorks) {
  const swipersWork = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](swipersWorks, {
    slidesPerView: 1,
    spaceBetween: 20,
    centeredSlides: true,
    loop: true,
...
const about = document.querySelector('.page-content');
if (about) {
  // const play = about.querySelector('.video__play');
  // const video = about.querySelector('.video video');
  // const videoBody = about.querySelector('.video');
